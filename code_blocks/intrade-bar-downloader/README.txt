...
Данная программа скачивает котировки брокера intrade.bar, которые совпадают с брокером FXCM.

Особенности использования
1) Программа не скачивает данные во время выходных дней.
2) Программа может скачивать цену bid, ask или находить цену (bid+ask)/2. 
Последний вариант подходит для бинарных опционов у брокера intrade.bar, 
5-ти или 3-х значная цена округляется к ближайшему значению (например, 1.6754651 округлится к 1.67547)
3) Цена закрытия бара совпадает с ценой, которую фиксирует брокер intrade.bar в начале минуты. 
Пример:
...
Переменная типа bool, которая включает или отключает пропуск текущего дня (по UTC времени). Это может пригодиться, если нужно скачать полные дни.
